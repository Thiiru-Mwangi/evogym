  ...
  return (
    <section id="home" className="gap-16 bg-gray-20 py-10 md:h-full md:pb-0">
      ...
      onViewportEnter={() => setSelectedPage(SelectedPage.Home)}>
        ...
        <div className="z-10 mt-32 md:basis-3/5">
          ...
          >
            ...
            <p className="mt-8 text-sm">
              ...
              Classes to get the Body Shapes that you Dream of.. Get Your Dream
              Body Now
            </p>
          </motion.div>
          {/* ACTIONS */}
        ...
        {/* IMAGE */}
        <div className="md:mt-32 z-10 flex basis-3/5 justify-center md:ml-40 md:justify-items-end">
